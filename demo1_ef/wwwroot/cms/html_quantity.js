function html_quantities(data)
{
	var element = document.createElement('div');
	var element_title = document.createElement('h2');
	element_title.textContent = "Quantities";
	element.appendChild(element_title);
	element.appendChild(html_quantities_table(data.quantities));
	return element;
}



function html_quantities_table(rows)
{
